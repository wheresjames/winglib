...
public:
	...
	*/
	...
	/**
		\param [in,out] digest		-	MD5 hash
		\param [in]		dwBuffers	-	Number of buffers in pArgs
		\param [in]		pArgs		-	Buffer pointer array

		Arguments are ( void *pBuffer, unsigned int uSize, etc... )

		Where <b>pBuffer</b> is a pointer to an individual buffer and 
		<b>dwSize</b> is the number of bytes in <b>pBuffer</b>.

		\return Non-zero if success
	*/
	static bool vHash( unsigned char digest[16], unsigned int uBuffers, void **pArgs);
	...
	/**
		\param [in,out] digest		-	MD5 hash
		\param [in]		dwBuffers	-	Number of buffers in pArgs
		\param [in]		...			-	Buffer pointer arguments
		...
		\return Non-zero if success
	*/
	static bool _cdecl Hash( unsigned char digest[16], unsigned int uBuffers, ... )
	{	return vHash( digest, uBuffers, ( (void**)&uBuffers ) + 1 ); }
