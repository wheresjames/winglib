...
SQBIND_REGISTER_CLASS_BEGIN( CLvRtspClient, CLvRtspClient )
	...
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getVideoPresentationTime )
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getVideoPresentationTimeSec )
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getVideoPresentationTimeUSec )
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getAudioPresentationTime )
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getAudioPresentationTimeSec )
	SQBIND_MEMBER_FUNCTION( CLvRtspClient, getAudioPresentationTimeUSec )
