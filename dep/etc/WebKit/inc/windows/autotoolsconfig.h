...
/* Define to enable optimized arithmetic */
#define ENABLE_JIT_OPTIMIZE_ARITHMETIC 1

/* Define to enable optimizing calls */
#define ENABLE_JIT_OPTIMIZE_CALL 1

/* Define to enable optimized property access */
#define ENABLE_JIT_OPTIMIZE_PROPERTY_ACCESS 1

/* Define to enable YARR */
#define ENABLE_YARR 1

/* Define to enable YARR JIT */
#define ENABLE_YARR_JIT 1

/* The gettext catalog name */
#define GETTEXT_PACKAGE "webkit"
...
#define PACKAGE_STRING "WebKit 1.1.8"
...
/* Define if target is DirectFB */
/* #undef WTF_PLATFORM_DIRECTFB */
